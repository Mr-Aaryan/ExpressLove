...
<div class="w-10/12 mx-auto">
    ...
    <div class="flex justify-between">
        <a href="/acceptance" class="ask border-2 px-6 py-3 bg-[#E30346] text-xl text-white rounded-full hover:cursor-pointer">Yes</a>
        <a href="/rejection" class="ask border-2 px-6 py-3 bg-[#E30346] text-xl text-white rounded-full hover:cursor-pointer">No</a>
    </div>
</div>
</Box>
